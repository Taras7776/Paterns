...
class Developer(Employee):
    ...
    def __init__(self, id: int, full_name: str, address: str, phone_number: str, email: str, position: str,
                 salary: str) -> None:
        """
...
class Task:
    ...
    def __init__(self, id: int, title: str, deadline: datetime, items: list[str], is_done: bool, in_progress: bool,
                 related_project: str):
        """
